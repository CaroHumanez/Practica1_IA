...
peliculas = [
    ("inception", "Inception", "nolan", "dicaprio", "ingles", "4K", 148, 8.8, "CienciaFiccion", "EdadPlus13", "Netflix"),
    ("matrix", "The Matrix", "wachowski", "reeves", "ingles", "BluRay", 136, 8.7, "CienciaFiccion", "EdadPlus16", "DisneyPlus"),
    ("prometheus", "Prometheus", "scott", "theron", "espanol", "HD", 124, 7.0, "CienciaFiccion", "EdadPlus16", "HBO_Max"),
    ("dune", "Dune", "scott", "isaac", "frances", "Streaming", 155, 8.1, "CienciaFiccion", "EdadPlus13", "Netflix"),
    
    ("ghostbusters", "Ghostbusters", "reitman", "murray", "ingles", "SD", 105, 7.8, "Comedia", "TP", "DisneyPlus"),
    ("barbie", "Barbie", "greta", "watson", "espanol", "4K", 114, 7.2, "Comedia", "EdadPlus7", "HBO_Max"),
    ("frenchdispatch", "The French Dispatch", "anderson", "bale", "frances", "BluRay", 108, 7.4, "Comedia", "EdadPlus13", "Netflix"),
    ("meanGirls", "Mean Girls", "waters", "gyllenhaal", "ingles", "HD", 97, 7.0, "Comedia", "EdadPlus13", "DisneyPlus"),
    
    ("getout", "Get Out", "peele", "washington", "ingles", "4K", 104, 7.7, "Terror", "EdadPlus16", "HBO_Max"),
    ("us", "Us", "peele", "nyong", "espanol", "Streaming", 116, 6.8, "Terror", "EdadPlus16", "Netflix"),
    ("residentEvil", "Resident Evil", "anderson", "jovovich", "frances", "HD", 100, 6.7, "Terror", "EdadPlus16", "DisneyPlus"),
    ("babadook", "The Babadook", "kent", "winslet", "ingles", "BluRay", 93, 6.8, "Terror", "EdadPlus13", "HBO_Max"),

    ("titanic", "Titanic", "cameron", "winslet", "espanol", "HD", 195, 7.8, "Drama", "EdadPlus13", "Netflix"),
    ("interstellar", "Interstellar", "nolan", "dicaprio", "ingles", "4K", 169, 8.6, "Drama", "EdadPlus13", "DisneyPlus"),
    ("nomadland", "Nomadland", "zhao", "watson", "frances", "Streaming", 108, 7.3, "Drama", "EdadPlus13", "HBO_Max"),
    ("littleWomen", "Little Women", "greta", "watson", "ingles", "BluRay", 135, 7.8, "Drama", "EdadPlus13", "Netflix"),

    ("fogofwar", "The Fog of War", "morris", "washington", "ingles", "SD", 95, 8.2, "Documental", "EdadPlus13", "DisneyPlus"),
    ("13th", "13th", "duvernay", "washington", "espanol", "Streaming", 100, 8.3, "Documental", "EdadPlus13", "HBO_Max"),
    ("citizenfour", "Citizenfour", "poitras", "watson", "frances", "HD", 114, 8.0, "Documental", "EdadPlus13", "Netflix"),
    ("civilwar", "The Civil War", "burns", "burns", "ingles", "BluRay", 70, 8.9, "Documental", "TP", "DisneyPlus")
]
...
# === Series ===
series = [
    ("strangerthings", "Stranger Things", "duffer", "brown", "ingles", "4K", 34, 8.7, "CienciaFiccion", "EdadPlus13", "contact", "Netflix"),
    ("chernobyl", "Chernobyl", "mazin", "harris", "ingles", "BluRay", 5, 9.4, "Drama", "EdadPlus16", None, "DisneyPlus"),
    ("dark", "Dark", "bood", "weise", "aleman", "Streaming", 26, 8.8, "CienciaFiccion", "EdadPlus13", None, "HBO_Max"),
    ("blackmirror", "Black Mirror", "brooker", "mara", "ingles", "Streaming", 27, 8.8, "CienciaFiccion", "EdadPlus16", None, "Netflix"),
    ("theoffice", "The Office", "daniels", "carell", "ingles", "HD", 201, 8.9, "Comedia", "TP", None, "DisneyPlus"),
    ("lupin", "Lupin", "sy", "omay", "frances", "Streaming", 15, 7.8, "Drama", "EdadPlus13", "gravity", "HBO_Max"),
    ("hillhouse", "The Haunting of Hill House", "flanagan", "pedretti", "ingles", "HD", 10, 8.6, "Terror", "EdadPlus16", "psycho", "Netflix"),
    ("cosmos", "Cosmos: A Spacetime Odyssey", "tyson", "tyson", "ingles", "Streaming", 13, 9.3, "Documental", "TP", None, "DisneyPlus"),
    ("loveDeathRobots", "Love, Death & Robots", "miller", "bernal", "espanol", "4K", 35, 8.4, "CienciaFiccion", "EdadPlus18", None, "HBO_Max"),
    ("modernfamily", "Modern Family", "levitan", "vergara", "ingles", "HD", 250, 8.5, "Comedia", "TP", None, "Netflix"),
    ("makingamurderer", "Making a Murderer", "demos", "avery", "ingles", "Streaming", 20, 8.6, "Documental", "EdadPlus16", None, "DisneyPlus"),
    ("marianne", "Marianne", "siri", "bela", "frances", "Streaming", 8, 7.5, "Terror", "EdadPlus18", None, "HBO_Max")
]
